...
\newcommand\titreStagiaire{Gérémy Michaud}
...
\newpage
\pagenumbering{Roman}
\include{1_resume}                % résumé français

\newpage
% Remerciements
\include{2_remerciements} 
...
\newpage
\include{3_symboles_abreviations}
\break
...
\newpage
\include{5_responsabilites_et_taches_du_stagiaire}


\newpage
\include{6_developpement_et_renforcement_des_competences}
