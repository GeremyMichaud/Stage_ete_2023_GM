...
this study aims to validate optical dosimetry methods in a water phantom through polarization of Cherenkov radiation while enhancing their precision and introducing a novel polarizer system.

\vspace{7.5pt}
\noindent\textbf{Methods: } Cherenkov emission is captured using a camera equipped with a charge-coupled device (CCD) image sensor during the irradiation of a water tank with dimensions of
